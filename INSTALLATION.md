...
kotlin {
    sourceSets {
        commonMain.dependencies {
            // Gunakan versi stabil 2.0.0 (Tanpa awalan 'v')
...
> [!TIP]
> **Penting**: Selalu gunakan versi `2.0.0` di kode Gradle Anda. Huruf `v` hanya digunakan untuk label Tag di GitHub, bukan untuk ID artifact Maven.
